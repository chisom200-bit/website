...
// API Setup
const API_KEY = "AIzaSyD9w3mH8c5njDrETXc_z8yiGaZdreSavnw";
...
const handleFormSubmit = (e) => {
    ...
    ${userData.file.data ? 
      ...
      `<p class="file-attachment"><span class="file-icon"><i class='bx bxs-file-doc'></i></span> ${userData.file.fileName}</p>`) 
      : ""}`;
    ...
    const botMsgHTML = `<img src="./img/AI avatar.jpg" class="avatar"><p class="message-text">Just a Sec...</p>`;
...
// Handle files input change (file upload)
fileInput.addEventListener("change", () => {
    ...
    reader.onload = (e) => {
        ...
        // Store the data in the userData Obj
...
document.addEventListener("click", ({ target }) => {
    ...
    wrapper.classList.toggle("hide-controls", showHide);
});
